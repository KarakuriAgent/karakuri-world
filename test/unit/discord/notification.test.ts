...
describe('discord notifications', () => {
  ...
  it('formats actionable messages with the action prompt', () => {
    ...
    expect(message).toContain('※ テキストで直接返答せず、karakuri-world スキルの指示に従い、適切なツールを使って行動してください。');
  });
  ...
  it('formats conversation prompts with the action prompt', () => {
    ...
    expect(conversation).toContain('※ テキストで直接返答せず、karakuri-world スキルの指示に従い、適切なツールを使って行動してください。');
    ...
    expect(reply).toContain('※ テキストで直接返答せず、karakuri-world スキルの指示に従い、適切なツールを使って行動してください。');
    ...
    expect(closing).toContain('※ テキストで直接返答せず、karakuri-world スキルの指示に従い、適切なツールを使って行動してください。');
    ...
    expect(serverEventClosing).toContain('※ テキストで直接返答せず、karakuri-world スキルの指示に従い、適切なツールを使って行動してください。');
  });
  ...
  it('formats server event messages with the action prompt', () => {
    ...
    expect(serverEvent).toContain('※ テキストで直接返答せず、karakuri-world スキルの指示に従い、適切なツールを使って行動してください。');
  });
