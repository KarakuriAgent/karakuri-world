...
[`karakuri-world-ui`](./karakuri-world-ui/README.md) は Godot 4 で構築されたデスクトップビューアーです。WebSocket でサーバーに接続し、タイルマップ・エージェント（アバター付き）・会話吹き出し・サーバーイベント演出をリアルタイムで表示します。セットアップと操作方法は README を参照してください。
