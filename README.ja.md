...
- Vercel Chat SDK + AI SDK + MCP で `karakuri-world` を操作します
- セットアップ手順、必要な環境変数、Docker Compose 例は [`karakuri-world-agent/README.md`](./karakuri-world-agent/README.md) を参照してください
