...
- 参照: docs/design/detailed/17-ui-rollout.md §1.2, docs/design/detailed/13-ui-relay-backend.md §5.4, §5.4.1, §8, docs/design/detailed/14-ui-history-api.md §7, docs/design/detailed/15-ui-application-shell.md §11, docs/plan/29-polling-r2-primary-architecture.md
...
- 依存: Unit 11, Unit 12, Unit 13, Unit 29。
