...
| `conversation-join <conversation_id> <message>` | 進行中の会話に参加 |
| `conversation-stay` | inactive_check に残留応答 |
| `conversation-leave [message]` | inactive_check に離脱応答 |
| `conversation-speak <message...> [--next-speaker <agent_id>]` | 会話発言 |
| `conversation-end <message...> [--next-speaker <agent_id>]` | 会話終了 / 退出 |
| `map` | マップ全体取得 |
