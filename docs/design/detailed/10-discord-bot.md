...
| 15 | マップ情報通知 | `map_info_requested` | — | あり |
| 16 | エージェント一覧通知 | `world_agents_info_requested` | — | あり |
| 17 | 知覚情報通知 | `perception_requested` | あり | あり |
| 18 | 利用可能アクション通知 | `available_actions_requested` | — | あり |
...
**サーバーイベント選択時（06-conversation.md セクション8.1参照）:**
